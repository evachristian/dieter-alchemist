...
const WARDROBE = {
  ...
  shoes: [
    ...
    { id: 'shoes_low_gloss', slot: 'shoes', kind: 'low', name: '로우 광택', rise: 5, heel: 5, finish: 'gloss', color: '#b8e4ff', emoji: '✨' },
    ...
    { id: 'shoes_ankle_gloss', slot: 'shoes', kind: 'ankle', name: '앵클 광택', rise: 16, heel: 5, finish: 'gloss', color: '#b8e4ff', emoji: '✨' },
    ...
    { id: 'shoes_tall_gloss', slot: 'shoes', kind: 'tall', name: '롱부츠 광택', rise: 34, heel: 5, finish: 'gloss', color: '#b8e4ff', emoji: '✨' },
  ],
// GEN:wardrobe>>>
  hairColor: [
