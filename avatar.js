...
(function () {
  ...
  const BODY = {
    ...
    // 보이던 것(라운드 숄더)이 여기서 왔다. 지금은 (118,108) → (132,113) → (136,120)
    // 으로 내려오면서 팔의 둥근 윗머리로 이어진다.
    //
    ...
    shoulderC: [[118, 108], [132, 113], [136, 120]],
    ...
    // ⚠️ **더 내리면 「어깨 부리」가 는다** — 마개 근처에서 팔이 가늘어서 몸통이 그 밖으로
    // 나온다. 116 에서 1.75px 로 한계를 넘었다. 114 가 눕힌 어깨선과 맞는 자리다.
