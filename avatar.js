  ...
  function hairFront(kind, c) {
    switch (kind) {
      ...
      case 'curtain':     // 커튼뱅 — 가운데를 열고 양옆으로 갈라 내린다.
        ...
        return `<path d="${BANG_OUT}
            C130,52 122,48 108,52 C104,58 101,64 100,72
            C99,64 96,58 92,52 C78,48 70,52 67,63.6 Z" fill="${c}"/>`;
      case 'sheer':       // 시스루뱅 — 성긴 잔머리 사이로 이마가 비친다.
        ...
        return `<path d="${BANG_OUT}
            Q128,38 123,59 Q118.5,38 114,59 Q109.5,38 105,59 Q100.5,38 96,59
            Q91.5,38 87,59 Q82.5,38 78,59 Q72,38 67,63.6 Z" fill="${c}"/>`;
      case 'plain':       // 기본 앞머리 — **처음에 있던 그 앞머리**.
        ...
        return `<path d="${BANG_OUT}
            C126,55.6 116,53.6 108,61.6 C104,53.6 96,53.6 92,61.6
            C84,53.6 74,55.6 67,63.6 Z" fill="${c}"/>`;
