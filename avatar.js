    ...
    switch (kind) {
      ...
      default: // long
        ...
        return crownOf(CROWN_LONG.rx, CROWN_LONG.ry, CROWN_LONG.cy) +
          `<path d="M63.1,65.8 C57.3,106.1 65.1,137.9 78.7,140 C92,130 97,110 88,90 C86,82 84,74 82.5,67.9 Z" fill="${c}"/>
           <path d="M136.9,65.8 C142.7,106.1 134.9,137.9 121.3,140 C108,130 103,110 112,90 C114,82 116,74 117.5,67.9 Z" fill="${c}"/>`;
    }
  }
